...
export default function QuizzesPage() {
  ...
  useEffect(() => {
    ...
    if (stored && sets.some((s) => s.id === stored)) setActiveId(stored)
  }, [])
  ...
  return (
    <li>
      ...
      >
        ...
        <p className="mt-0.5 truncate text-xs text-gray">{set.questions.length} questions · {set.flashcards.length} cards</p>
      </button>
    </li>
  )
}
