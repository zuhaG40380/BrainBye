        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {question.options.map((opt, i) => {
              ...
              else if (showState && isThisSelected && !isThisCorrect)
                stateClasses = 'border-[#c98a6b]/50 bg-[#c98a6b]/10 text-[#e3b9a4]'
          ...
          {selected !== null && (
            ...
            >
              <p className={`text-sm ${isCorrect ? 'text-cream' : 'text-[#e3b9a4]'}`}>
                {isCorrect
                  ? 'Correct.'
                  : `Not quite — the answer was "${question.options[question.correctIndex]}".`}
              </p>
              <button
                onClick={next}
